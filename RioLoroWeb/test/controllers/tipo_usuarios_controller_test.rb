...
class TipoUsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_usuario" do
    assert_difference('TipoUsuario.count') do
      post tipo_usuarios_url, params: { tipo_usuario: { nivelPermiso: @tipo_usuario.nivelPermiso, nombreTipo: @tipo_usuario.nombreTipo } }
    end
  ...
  test "should update tipo_usuario" do
    patch tipo_usuario_url(@tipo_usuario), params: { tipo_usuario: { nivelPermiso: @tipo_usuario.nivelPermiso, nombreTipo: @tipo_usuario.nombreTipo } }
