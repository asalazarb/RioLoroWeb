...
class EspeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especy" do
    assert_difference('Especie.count') do
      post especies_url, params: { especy: { estaEnPeligro: @especy.estaEnPeligro, imagen: @especy.imagen, nombreCientifico: @especy.nombreCientifico, nombreComun: @especy.nombreComun, taxomomia: @especy.taxomomia } }
    end
  ...
  test "should update especy" do
    patch especy_url(@especy), params: { especy: { estaEnPeligro: @especy.estaEnPeligro, imagen: @especy.imagen, nombreCientifico: @especy.nombreCientifico, nombreComun: @especy.nombreComun, taxomomia: @especy.taxomomia } }
